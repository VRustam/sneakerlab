...
class _ForgotPasswordScreenState extends ConsumerState<ForgotPasswordScreen> {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Reset password')), body: Padding(
    ...
    child: Column(children: [
      ...
      FilledButton(onPressed: () async { final error = await ref.read(authRepositoryProvider).requestPasswordReset(_email.text.trim()); if (mounted) setState(() => _message = error ?? 'If the email is eligible, reset instructions are on the way.'); }, child: const Text('Send reset instructions')),
