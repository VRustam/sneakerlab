          ...
          children: [
            Card(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Sneakers for every angle.',
                      style: Theme.of(context).textTheme.headlineSmall,
                    ),
                    const SizedBox(height: 8),
                    const Text(
                      'Discover active catalog styles, saved favorites, and secure demo checkout.',
                    ),
                    const SizedBox(height: 12),
                    FilledButton(
                      onPressed: () => context.go('/products'),
                      child: const Text('Shop sneakers'),
                    ),
                  ],
                ),
              ),
                      ...
                      (item) => ActionChip(
                        ...
                        onPressed: () {
                          ref
                              ...
                              .update(CatalogFilter(categorySlug: item.slug));
                          context.go('/products');
                        },
                      ),
                    )
            ...
            products.when(
              ...
              error: (_, _) => ErrorState(
                message: 'Featured products are unavailable.',
            ...
            const ListTile(
              ...
              title: Text('3D viewer teaser'),
              subtitle: Text(
                'Supported product models receive an interactive mobile viewer in the final portfolio phase.',
              ),
            ),
          ],
        ),
