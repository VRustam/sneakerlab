...
| 3. Responsive storefront, catalog, and favorites                       | blocked     | Requires a running local Supabase stack to implement and verify active-product queries, favorites ownership, and seeded Playwright flows. | Start Docker Desktop, run the Phase 2 local validation, then continue Phase 3. |
